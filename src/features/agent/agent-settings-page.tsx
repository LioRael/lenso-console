  ...
  return (
    <div className={styles.contentColumn}>
      ...
      <SectionHeading
        ...
        title="Lenso Agent"
      />
      <Surface className={styles.toggleList} level="panel">
        <ToggleRow
          checked={agentEnabled}
          description="Allow conversations with Lenso Agent inside your workspace"
          label="Enable Lenso Agent"
          onChange={setAgentEnabled}
        />
        <ToggleRow
          checked={webEnabled}
          description="Allow Lenso Agent to search the public web for current information and cite sources"
      ...
      >
        <Surface className={styles.toggleList} level="panel">
          <ToggleRow
            checked={mcpEnabled}
            description="Allow Lenso Agent to use MCP connectors."
            label="Enable MCP connectors"
            onChange={setMcpEnabled}
          />
          <div className={styles.manageRow}>
            <span>
              <strong>Allowed MCP connectors</strong>
              <small>
                Configure which MCP connectors can be used in this workspace
              </small>
            </span>
            <Button size="compact" variant="ghost">
