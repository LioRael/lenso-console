...
Implementation has started in [the marketplace package](../plugins/marketplace/README.md):
...
[ADR-0007](adr/0007-use-an-open-signed-plugin-marketplace.md). It preserves
[Shell/App separation](adr/0010-separate-console-shell-from-app-assembly.md).
...
workers and database remain private directory implementation details. Source can
start in an independently buildable package; a new repository is a delivery
choice, not the ownership mechanism. Do not add the business implementation to
