...
fn main() {
    ...
    if env::var_os("LENSO_UPDATE_CONTRACT_SNAPSHOT").is_some() {
        ...
        .expect("failed to update generated Rust observability query contract");
        write_projection(
            Path::new("capability.json"),
            ProjectionLanguage::TypeScript,
            Path::new("generated/bindings.ts"),
        )
        .expect("failed to update generated TypeScript observability query contract");
        return;
    }
    check_projection(
        Path::new("capability.json"),
    ...
    .expect("generated Rust observability query contract is stale");
    check_projection(
        Path::new("capability.json"),
        ProjectionLanguage::TypeScript,
        Path::new("generated/bindings.ts"),
    )
    .expect("generated TypeScript observability query contract is stale");
}
