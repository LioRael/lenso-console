...
Catalog page composition remains local in `plugins/marketplace/web/ui`.
...
See `plugins/marketplace/ui-review.md` for the current boundary and validation scope.
